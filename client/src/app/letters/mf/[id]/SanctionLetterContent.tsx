  ...
  return (
    <div className="min-h-screen bg-neutral-100 p-4 md:p-8 flex flex-col items-center text-black font-sans sanction-letter-container">
      ...
      <div className="w-full max-w-[800px] bg-white shadow-2xl print-shadow-none print-full-width flex flex-col sanction-letter">
        <div className="bg-red-600 print-exact-blue text-white print-exact-white p-6 md:p-7 mb-3">
          <div className="flex justify-between items-start">
            <div className="space-y-3">
              <Image
                width={600}
                height={300}
                src={"https://online.muthootfinance.com/assets/img/img/logo.png"}
                alt="Muthoot Finance Logo"
                className="h-10 w-auto object-contain brightness-0 invert print-logo-invert"
                unoptimized
              />
