...
const SanctionLetterContent = ({
  ...
  const handleDownloadPDF = async () => {
    ...
    pdf.addImage(imgData, "JPEG", 0, 0, pdfWidth, pdfHeight > a4Height ? a4Height : pdfHeight);
  ...
  return (
    <div className="min-h-screen bg-neutral-100 p-4 md:p-8 flex flex-col items-center text-black font-sans sanction-letter-container">
      ...
      <div className="w-full max-w-[800px] bg-white shadow-2xl print-shadow-none print-full-width flex flex-col sanction-letter">
        <div className="bg-yellow-300 print-exact-blue text-black print-exact-white p-6 md:p-7 mb-3">
          <div className="flex justify-between items-start">
            <div className="space-y-3">
              ...
              />
              <div className="text-xs text-black font-sans leading-tight opacity-95">
            ...
            <div className="text-right font-sans text-[11px] leading-tight space-y-1.5 pt-1">
              <p className="font-bold text-sm uppercase tracking-wider">LOAN SANCTION LETTER</p>
              <p className="text-black font-semibold uppercase">REF: SL-{id}</p>
              <p className="text-black font-semibold">DATE: {sanctionDateString}</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 space-y-4 text-[12px] leading-snug px-10 md:px-12 py-4 min-h-[80dvh] print:min-h-[75dvh]">
          ...
          <p>
            ...
            <br />
            With reference to your application for a personal loan, we are pleased to inform you
            that your request has been approved in principle. The sanction of the loan is subject to
          ...
          <div className="space-y-2">
            ...
            <div className="text-[13px]">
              <p>
                This offer is valid until <span className="font-bold">{validUntilString}</span>.
              </p>
              <p>
                The sanctioned amount will be disbursed to the following bank account after digital
                verification:
              </p>
          ...
          <div className="flex items-center justify-between gap-4 mt-20">
            <div className="flex-1">
              <p className="text-xs italic leading-tight">
                <span className="font-bold">Note:</span> This is an electronically generated
                document. No physical signature is required. For any assistance, please contact us
                at{" "}
                <Link href="mailto:support@tatacapital.com" className="font-bold underline">
